...
CREATE TABLE "challan_items" (
    ...
    "snapshotUnitPrice" DECIMAL(10,2) NOT NULL,
    "quantity" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "challan_items" ADD CONSTRAINT "challan_items_salesChallanId_fkey" FOREIGN KEY ("salesChallanId") REFERENCES "sales_challans"("id") ON DELETE CASCADE ON UPDATE CASCADE;
